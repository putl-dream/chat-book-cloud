    ...
    public void handleMessage(String userId, UserChatMessage message) {
        ...
        if (message.getData() != null) {
            ...
            try {
                ...
                // 发送给接收者
                messagePublisher.sendToUser(String.valueOf(receiverId), MessageResult.messageUser(message.getData()));
                
                // 发送给发送者（确认）
                messagePublisher.sendToUser(userId, MessageResult.messageSystem("消息发送成功！"));
