...
(
    ...
    scene_type        varchar(16)                            not null comment 'DISCUSS/LEARN/DRAFT/EDIT',
    ...
    notebook_summary  longtext                               null comment '共享工作记忆 JSON',
...
(
    ...
    message_type varchar(32)  default 'text'            not null comment '消息类型：text/interactive_form',
    content      longtext                               not null comment '消息内容',
    payload      longtext                               null comment '结构化消息载荷 JSON',
