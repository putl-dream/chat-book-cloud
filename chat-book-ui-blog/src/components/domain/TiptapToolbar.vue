        ...
        <template #dropdown>
          <el-dropdown-menu>
            <el-dropdown-item command="left" :class="{ 'is-active': editor.isActive({ textAlign: 'left' }) }">
               <div class="flex-row">
                 <svg viewBox="0 0 24 24" width="14" height="14" fill="currentColor"><path :d="icons.alignLeft" /></svg> 左对齐
               </div>
            </el-dropdown-item>
            ...
            <el-dropdown-item command="right" :class="{ 'is-active': editor.isActive({ textAlign: 'right' }) }">
               <div class="flex-row">
                 <svg viewBox="0 0 24 24" width="14" height="14" fill="currentColor"><path :d="icons.alignRight" /></svg> 右对齐
               </div>
            </el-dropdown-item>
