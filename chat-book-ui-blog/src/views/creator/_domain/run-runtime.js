...
const SOCKET_TO_RUNTIME_EVENT = Object.freeze({
    AGENT_CHAT_START: AGENT_RUNTIME_EVENT.MESSAGE_STARTED,
    AGENT_CHAT_DELTA: AGENT_RUNTIME_EVENT.MESSAGE_DELTA,
    AGENT_CHAT_DONE: AGENT_RUNTIME_EVENT.MESSAGE_COMPLETED,
    AGENT_CHAT_ERROR: AGENT_RUNTIME_EVENT.MESSAGE_FAILED,
    AGENT_DRAFT_GENERATE_START: AGENT_RUNTIME_EVENT.ARTIFACT_STARTED,
    AGENT_DRAFT_GENERATE_DELTA: AGENT_RUNTIME_EVENT.ARTIFACT_DELTA,
    AGENT_DRAFT_GENERATE_STATUS: AGENT_RUNTIME_EVENT.ARTIFACT_STATUS,
    AGENT_DRAFT_GENERATE_DONE: AGENT_RUNTIME_EVENT.ARTIFACT_COMPLETED,
    AGENT_DRAFT_GENERATE_ERROR: AGENT_RUNTIME_EVENT.ARTIFACT_FAILED,
    AGENT_DRAFT_GENERATE_STOPPED: AGENT_RUNTIME_EVENT.ARTIFACT_STOPPED
});
